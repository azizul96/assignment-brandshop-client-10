...
const ProductCard = ({product}) => {
    ...
    return (
        <div className="">
            <div className="  rounded-lg mb-5  text-center p-5 shadow-lg">
            ...
            <div className="flex justify-center items-center  mb-1">
                <p className="font-semibold text-green-700"> {rating}</p>
            ...
            <Link to={`/update/${_id}`}>
                <button  className="btn btn-sm btn-secondary text-white mr-2 mb-2">Update</button>
            </Link>
            <Link to={`/details/${_id}`}>
                <button  className="btn btn-sm btn-secondary text-white mr-2 mb-2">Details</button>
            </Link>
        </div>
        </div>
    );
